...
/*   Updated: 2024/08/29 15:15:37 by rbryento         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_file_ext(t_minishell *mini_data, char *file, char *first_arg)
{
...
int	check_file(t_minishell *mini_data, char *file, char *first_arg)
{
	...
	return (check_file_ext(mini_data, file, first_arg));
}
